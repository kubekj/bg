...
import AssignPlanModal from "../../modals/assign-plan";
                ...
                <Link
                  href={{
                    ...
                    query: {
                      ...
                      id: plan.id,
                      goBack: `/athlete/training/plan`,
                    },
                  }}
                  style={{ textDecoration: "none" }}
                >
                  <div className={`${style.userInfo} text-gray-700`}>
                    <Image
        ...
        <div className={style.bottom}>
          ...
          <div className={style.rightBottom}>
            ...
            <div className={style.apply}>
              <AssignPlanModal
                plan={plan}
                icon='/thumbnails/checkmark-outline.svg'
                borderValue='none'
